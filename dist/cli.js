...
// src/cli.ts
program.name("doccrunch").description("Document ingestion engine: any doc \u2192 normalized JSON").version("0.1.0");
program.command("parse <file>").description("Parse a document file and emit validated JSON").option(
  "--type <type>",
